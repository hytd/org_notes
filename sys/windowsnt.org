...
| get2.adobe.com/cn/flashplayer                                      | adobe flash player                                                                                                                          |
* File
*Hosts*
#+BEGIN_QUOTE
...
- 下载 thinkphp
#+BEGIN_SRC 
composer create-project topthink/think $www\thinkphp
#+END_SRC
#+BEGIN_QUOTE
topthink/think 指的是[[https://packagist.org][ packagist]] *包* 地址
#+END_QUOTE
- 同 ~url_rewrite~
- 配置 httpd.conf
#+BEGIN_EXAMPLE
...
#+END_EXAMPLE
#+BEGIN_QUOTE
加载了 =mod_authz_host.so= 依旧提示
#+BEGIN_EXAMPLE
Invalid command 'roder', perhaps misspelled or defined by a module not included in the server configuration
#+END_EXAMPLE
in apache2.2
#+BEGIN_EXAMPLE
Order allow,deny
